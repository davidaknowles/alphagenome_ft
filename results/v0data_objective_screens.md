...
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `allen_atac` | 0.5861 | 0.5420 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `allen_rna` | 0.3405 | 0.4684 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `hda_atac` | 0.8069 | 0.8183 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `hda_rna` | 0.4586 | 0.6662 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `liu_atac` | 0.7681 | 0.7873 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `liu_rna` | 0.7051 | 0.4960 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `zemke2023_atac` | 0.4505 | 0.6759 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `zemke2023_rna` | 0.3372 | 0.2121 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `zemke2024_all_atac` | 0.7492 | 0.7599 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 21 | `zemke2024_all_rna` | 0.4211 | 0.2983 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `allen_atac` | 0.5849 | 0.5412 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `allen_rna` | 0.3425 | 0.4714 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `hda_atac` | 0.8063 | 0.8180 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `hda_rna` | 0.4599 | 0.6679 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `liu_atac` | 0.7673 | 0.7869 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `liu_rna` | 0.6990 | 0.4986 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `zemke2023_atac` | 0.4575 | 0.6756 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `zemke2023_rna` | 0.3386 | 0.2132 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `zemke2024_all_atac` | 0.7490 | 0.7603 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 21 | `zemke2024_all_rna` | 0.4258 | 0.3003 |
