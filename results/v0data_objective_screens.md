...
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `allen_atac` | 0.5858 | 0.5416 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `allen_rna` | 0.3373 | 0.4661 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `hda_atac` | 0.8071 | 0.8185 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `hda_rna` | 0.4763 | 0.6532 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `liu_atac` | 0.7684 | 0.7881 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `liu_rna` | 0.7352 | 0.4964 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `zemke2023_atac` | 0.4481 | 0.6755 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `zemke2023_rna` | 0.3356 | 0.2080 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `zemke2024_all_atac` | 0.7483 | 0.7613 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_reset` | 22 | `zemke2024_all_rna` | 0.4191 | 0.2850 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `allen_atac` | 0.5844 | 0.5404 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `allen_rna` | 0.3389 | 0.4669 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `hda_atac` | 0.8065 | 0.8184 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `hda_rna` | 0.4829 | 0.6529 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `liu_atac` | 0.7674 | 0.7878 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `liu_rna` | 0.7155 | 0.4977 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `zemke2023_atac` | 0.4482 | 0.6744 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `zemke2023_rna` | 0.3362 | 0.2049 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `zemke2024_all_atac` | 0.7477 | 0.7612 |
| `joint_all_nonencode` | `lora+locon` | `lr1e4_rnaw2_reset` | 22 | `zemke2024_all_rna` | 0.4207 | 0.2859 |
