...
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `allen_atac` | 0.5809 | 0.5361 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `allen_rna` | 0.3329 | 0.4617 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `hda_atac` | 0.8024 | 0.8140 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `hda_rna` | 0.4543 | 0.6639 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `liu_atac` | 0.7677 | 0.7862 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `liu_rna` | 0.6411 | 0.4773 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `zemke2023_atac` | 0.4607 | 0.6699 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `zemke2023_rna` | 0.3375 | 0.2174 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `zemke2024_all_atac` | 0.7490 | 0.7594 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 16 | `zemke2024_all_rna` | 0.4186 | 0.2854 |
