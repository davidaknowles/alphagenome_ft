...
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `allen_atac` | 0.5729 | 0.5295 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `allen_rna` | 0.3184 | 0.4596 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `hda_atac` | 0.8009 | 0.8134 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `hda_rna` | 0.4701 | 0.6504 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `liu_atac` | 0.7680 | 0.7863 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `liu_rna` | 0.7078 | 0.5032 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `zemke2023_atac` | 0.4210 | 0.6657 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `zemke2023_rna` | 0.3039 | 0.2134 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `zemke2024_all_atac` | 0.7489 | 0.7611 |
| `joint_all_nonencode` | `lora+locon` | `lr3e4_reset` | 9 | `zemke2024_all_rna` | 0.3747 | 0.2983 |
