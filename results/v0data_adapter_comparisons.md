...
| `joint-all-nonencode` | `lora` | 3 | `allen_atac` | 0.5291 | 0.4844 |
| `joint-all-nonencode` | `lora` | 3 | `allen_rna` | 0.2841 | 0.3973 |
| `joint-all-nonencode` | `lora` | 3 | `hda_atac` | 0.7756 | 0.7894 |
| `joint-all-nonencode` | `lora` | 3 | `hda_rna` | 0.4523 | 0.5940 |
| `joint-all-nonencode` | `lora` | 3 | `liu_atac` | 0.7558 | 0.7743 |
| `joint-all-nonencode` | `lora` | 3 | `liu_rna` | 0.5278 | 0.4584 |
| `joint-all-nonencode` | `lora` | 3 | `zemke2023_atac` | 0.3845 | 0.6356 |
| `joint-all-nonencode` | `lora` | 3 | `zemke2023_rna` | 0.2640 | 0.1715 |
| `joint-all-nonencode` | `lora` | 3 | `zemke2024_all_atac` | 0.7277 | 0.7386 |
| `joint-all-nonencode` | `lora` | 3 | `zemke2024_all_rna` | 0.3378 | 0.2361 |
| `joint-all-nonencode` | `lora+locon` | 3 | `allen_atac` | 0.5316 | 0.4890 |
| `joint-all-nonencode` | `lora+locon` | 3 | `allen_rna` | 0.2879 | 0.4082 |
| `joint-all-nonencode` | `lora+locon` | 3 | `hda_atac` | 0.7800 | 0.7940 |
| `joint-all-nonencode` | `lora+locon` | 3 | `hda_rna` | 0.4391 | 0.6008 |
| `joint-all-nonencode` | `lora+locon` | 3 | `liu_atac` | 0.7533 | 0.7730 |
| `joint-all-nonencode` | `lora+locon` | 3 | `liu_rna` | 0.5685 | 0.4898 |
| `joint-all-nonencode` | `lora+locon` | 3 | `zemke2023_atac` | 0.3926 | 0.6405 |
| `joint-all-nonencode` | `lora+locon` | 3 | `zemke2023_rna` | 0.2583 | 0.1730 |
| `joint-all-nonencode` | `lora+locon` | 3 | `zemke2024_all_atac` | 0.7293 | 0.7460 |
| `joint-all-nonencode` | `lora+locon` | 3 | `zemke2024_all_rna` | 0.3390 | 0.2305 |
