...
| `joint-all-nonencode` | `lora` | 1 | `allen_atac` | 0.5068 | 0.4662 |
| `joint-all-nonencode` | `lora` | 1 | `allen_rna` | 0.2506 | 0.3715 |
| `joint-all-nonencode` | `lora` | 1 | `hda_atac` | 0.7475 | 0.7615 |
| `joint-all-nonencode` | `lora` | 1 | `hda_rna` | 0.3923 | 0.4926 |
| `joint-all-nonencode` | `lora` | 1 | `liu_atac` | 0.7475 | 0.7656 |
| `joint-all-nonencode` | `lora` | 1 | `liu_rna` | 0.4120 | 0.4115 |
| `joint-all-nonencode` | `lora` | 1 | `zemke2023_atac` | 0.3663 | 0.6048 |
| `joint-all-nonencode` | `lora` | 1 | `zemke2023_rna` | 0.2134 | 0.1340 |
| `joint-all-nonencode` | `lora` | 1 | `zemke2024_all_atac` | 0.7117 | 0.7266 |
| `joint-all-nonencode` | `lora` | 1 | `zemke2024_all_rna` | 0.2586 | 0.1747 |
| `joint-all-nonencode` | `lora+locon` | 1 | `allen_atac` | 0.5051 | 0.4642 |
| `joint-all-nonencode` | `lora+locon` | 1 | `allen_rna` | 0.2649 | 0.3738 |
| `joint-all-nonencode` | `lora+locon` | 1 | `hda_atac` | 0.7465 | 0.7583 |
| `joint-all-nonencode` | `lora+locon` | 1 | `hda_rna` | 0.4182 | 0.5091 |
| `joint-all-nonencode` | `lora+locon` | 1 | `liu_atac` | 0.7465 | 0.7651 |
| `joint-all-nonencode` | `lora+locon` | 1 | `liu_rna` | 0.4021 | 0.4154 |
| `joint-all-nonencode` | `lora+locon` | 1 | `zemke2023_atac` | 0.3647 | 0.6012 |
| `joint-all-nonencode` | `lora+locon` | 1 | `zemke2023_rna` | 0.2214 | 0.1423 |
| `joint-all-nonencode` | `lora+locon` | 1 | `zemke2024_all_atac` | 0.7131 | 0.7262 |
| `joint-all-nonencode` | `lora+locon` | 1 | `zemke2024_all_rna` | 0.2705 | 0.1858 |
