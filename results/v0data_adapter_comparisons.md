...
| `liu-hdma` | `lora` | 7 | `liu_atac` | 0.7745 | 0.7920 |
| `liu-hdma` | `lora` | 7 | `liu_rna` | 0.6549 | 0.5368 |
| `liu-hdma` | `lora+locon` | 7 | `liu_atac` | 0.7751 | 0.7934 |
| `liu-hdma` | `lora+locon` | 7 | `liu_rna` | 0.6750 | 0.4984 |
...
| `johansen_joint` | `lora` | 1 | `allen_atac` | 0.5270 | 0.4840 |
| `johansen_joint` | `lora` | 1 | `allen_rna` | 0.2406 | 0.3564 |
| `liu-hdma` | `lora` | 6 | `liu_atac` | 0.7737 | 0.7903 |
| `liu-hdma` | `lora` | 6 | `liu_rna` | 0.6623 | 0.4893 |
| `liu-hdma` | `lora+locon` | 6 | `liu_atac` | 0.7728 | 0.7909 |
| `liu-hdma` | `lora+locon` | 6 | `liu_rna` | 0.7169 | 0.4978 |
| `zemke2023-human` | `lora` | 4 | `zemke2023_atac` | 0.6957 | 0.7112 |
| `zemke2023-human` | `lora` | 4 | `zemke2023_rna` | 0.4809 | 0.4051 |
| `zemke2023-human` | `lora+locon` | 4 | `zemke2023_atac` | 0.6971 | 0.7151 |
| `zemke2023-human` | `lora+locon` | 4 | `zemke2023_rna` | 0.4987 | 0.4099 |
