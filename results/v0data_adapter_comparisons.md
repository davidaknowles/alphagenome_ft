...
| `joint-all-nonencode` | `lora` | 6 | `allen_atac` | 0.5523 | 0.5087 |
| `joint-all-nonencode` | `lora` | 6 | `allen_rna` | 0.2990 | 0.4006 |
| `joint-all-nonencode` | `lora` | 6 | `hda_atac` | 0.7902 | 0.8033 |
| `joint-all-nonencode` | `lora` | 6 | `hda_rna` | 0.4714 | 0.6165 |
| `joint-all-nonencode` | `lora` | 6 | `liu_atac` | 0.7631 | 0.7817 |
| `joint-all-nonencode` | `lora` | 6 | `liu_rna` | 0.7099 | 0.4879 |
| `joint-all-nonencode` | `lora` | 6 | `zemke2023_atac` | 0.3946 | 0.6475 |
| `joint-all-nonencode` | `lora` | 6 | `zemke2023_rna` | 0.2785 | 0.1897 |
| `joint-all-nonencode` | `lora` | 6 | `zemke2024_all_atac` | 0.7393 | 0.7472 |
| `joint-all-nonencode` | `lora` | 6 | `zemke2024_all_rna` | 0.3623 | 0.2560 |
| `joint-all-nonencode` | `lora+locon` | 6 | `allen_atac` | 0.5509 | 0.5100 |
| `joint-all-nonencode` | `lora+locon` | 6 | `allen_rna` | 0.2906 | 0.4153 |
| `joint-all-nonencode` | `lora+locon` | 6 | `hda_atac` | 0.7938 | 0.8072 |
| `joint-all-nonencode` | `lora+locon` | 6 | `hda_rna` | 0.4574 | 0.6339 |
| `joint-all-nonencode` | `lora+locon` | 6 | `liu_atac` | 0.7636 | 0.7816 |
| `joint-all-nonencode` | `lora+locon` | 6 | `liu_rna` | 0.6735 | 0.4759 |
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2023_atac` | 0.4041 | 0.6527 |
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2023_rna` | 0.2760 | 0.1934 |
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2024_all_atac` | 0.7355 | 0.7499 |
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2024_all_rna` | 0.3539 | 0.2630 |
...
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2024_all_atac` | 0.7355 | 0.7499 |
| `joint-all-nonencode` | `lora+locon` | 6 | `zemke2024_all_rna` | 0.3539 | 0.2630 |
| `joint-all-nonencode` | `lora` | 9 | `allen_atac` | 0.5597 | 0.5172 |
| `joint-all-nonencode` | `lora` | 9 | `allen_rna` | 0.3084 | 0.4560 |
| `joint-all-nonencode` | `lora` | 9 | `hda_atac` | 0.7913 | 0.8026 |
| `joint-all-nonencode` | `lora` | 9 | `hda_rna` | 0.4679 | 0.6240 |
| `joint-all-nonencode` | `lora` | 9 | `liu_atac` | 0.7644 | 0.7837 |
| `joint-all-nonencode` | `lora` | 9 | `liu_rna` | 0.7755 | 0.4845 |
| `joint-all-nonencode` | `lora` | 9 | `zemke2023_atac` | 0.4116 | 0.6568 |
| `joint-all-nonencode` | `lora` | 9 | `zemke2023_rna` | 0.3023 | 0.1903 |
| `joint-all-nonencode` | `lora` | 9 | `zemke2024_all_atac` | 0.7388 | 0.7485 |
| `joint-all-nonencode` | `lora` | 9 | `zemke2024_all_rna` | 0.3997 | 0.2848 |
