...
| `joint-all-nonencode` | `lora` | 4 | `allen_atac` | 0.5353 | 0.4928 |
| `joint-all-nonencode` | `lora` | 4 | `allen_rna` | 0.2726 | 0.3921 |
| `joint-all-nonencode` | `lora` | 4 | `hda_atac` | 0.7808 | 0.7975 |
| `joint-all-nonencode` | `lora` | 4 | `hda_rna` | 0.4460 | 0.6503 |
| `joint-all-nonencode` | `lora` | 4 | `liu_atac` | 0.7598 | 0.7777 |
| `joint-all-nonencode` | `lora` | 4 | `liu_rna` | 0.5703 | 0.4522 |
| `joint-all-nonencode` | `lora` | 4 | `zemke2023_atac` | 0.4065 | 0.6401 |
| `joint-all-nonencode` | `lora` | 4 | `zemke2023_rna` | 0.2753 | 0.1891 |
| `joint-all-nonencode` | `lora` | 4 | `zemke2024_all_atac` | 0.7297 | 0.7378 |
| `joint-all-nonencode` | `lora` | 4 | `zemke2024_all_rna` | 0.3562 | 0.2517 |
| `joint-all-nonencode` | `lora+locon` | 4 | `allen_atac` | 0.5386 | 0.4981 |
| `joint-all-nonencode` | `lora+locon` | 4 | `allen_rna` | 0.2768 | 0.3906 |
| `joint-all-nonencode` | `lora+locon` | 4 | `hda_atac` | 0.7805 | 0.7951 |
| `joint-all-nonencode` | `lora+locon` | 4 | `hda_rna` | 0.4440 | 0.6459 |
| `joint-all-nonencode` | `lora+locon` | 4 | `liu_atac` | 0.7613 | 0.7787 |
| `joint-all-nonencode` | `lora+locon` | 4 | `liu_rna` | 0.5535 | 0.4809 |
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2023_atac` | 0.4120 | 0.6421 |
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2023_rna` | 0.2544 | 0.2004 |
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2024_all_atac` | 0.7340 | 0.7398 |
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2024_all_rna` | 0.3527 | 0.2397 |
| `liu-hdma` | `lora` | 9 | `liu_atac` | 0.7746 | 0.7941 |
| `liu-hdma` | `lora` | 9 | `liu_rna` | 0.6534 | 0.4776 |
| `liu-hdma` | `lora+locon` | 9 | `liu_atac` | 0.7723 | 0.7928 |
| `liu-hdma` | `lora+locon` | 9 | `liu_rna` | 0.5560 | 0.4998 |
...
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2024_all_atac` | 0.7340 | 0.7398 |
| `joint-all-nonencode` | `lora+locon` | 4 | `zemke2024_all_rna` | 0.3527 | 0.2397 |
| `joint-all-nonencode` | `lora` | 5 | `allen_atac` | 0.5402 | 0.4961 |
| `joint-all-nonencode` | `lora` | 5 | `allen_rna` | 0.2685 | 0.3751 |
| `joint-all-nonencode` | `lora` | 5 | `hda_atac` | 0.7847 | 0.7978 |
| `joint-all-nonencode` | `lora` | 5 | `hda_rna` | 0.4808 | 0.6188 |
| `joint-all-nonencode` | `lora` | 5 | `liu_atac` | 0.7637 | 0.7809 |
| `joint-all-nonencode` | `lora` | 5 | `liu_rna` | 0.6024 | 0.4487 |
| `joint-all-nonencode` | `lora` | 5 | `zemke2023_atac` | 0.3905 | 0.6425 |
| `joint-all-nonencode` | `lora` | 5 | `zemke2023_rna` | 0.2762 | 0.1859 |
| `joint-all-nonencode` | `lora` | 5 | `zemke2024_all_atac` | 0.7303 | 0.7404 |
| `joint-all-nonencode` | `lora` | 5 | `zemke2024_all_rna` | 0.3705 | 0.2441 |
| `liu-hdma` | `lora` | 8 | `liu_atac` | 0.7737 | 0.7920 |
| `liu-hdma` | `lora` | 8 | `liu_rna` | 0.7420 | 0.4927 |
| `liu-hdma` | `lora+locon` | 8 | `liu_atac` | 0.7747 | 0.7935 |
| `liu-hdma` | `lora+locon` | 8 | `liu_rna` | 0.7406 | 0.4870 |
| `zemke2023-human` | `lora` | 4 | `zemke2023_atac` | 0.6957 | 0.7112 |
| `zemke2023-human` | `lora` | 4 | `zemke2023_rna` | 0.4809 | 0.4051 |
| `zemke2023-human` | `lora+locon` | 4 | `zemke2023_atac` | 0.6971 | 0.7151 |
| `zemke2023-human` | `lora+locon` | 4 | `zemke2023_rna` | 0.4987 | 0.4099 |
