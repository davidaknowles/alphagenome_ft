...
| `joint-all-nonencode` | `lora` | 2 | `allen_atac` | 0.5220 | 0.4826 |
| `joint-all-nonencode` | `lora` | 2 | `allen_rna` | 0.2623 | 0.3835 |
| `joint-all-nonencode` | `lora` | 2 | `hda_atac` | 0.7643 | 0.7806 |
| `joint-all-nonencode` | `lora` | 2 | `hda_rna` | 0.4404 | 0.6366 |
| `joint-all-nonencode` | `lora` | 2 | `liu_atac` | 0.7553 | 0.7732 |
| `joint-all-nonencode` | `lora` | 2 | `liu_rna` | 0.4205 | 0.4437 |
| `joint-all-nonencode` | `lora` | 2 | `zemke2023_atac` | 0.3833 | 0.6246 |
| `joint-all-nonencode` | `lora` | 2 | `zemke2023_rna` | 0.2558 | 0.1715 |
| `joint-all-nonencode` | `lora` | 2 | `zemke2024_all_atac` | 0.7250 | 0.7329 |
| `joint-all-nonencode` | `lora` | 2 | `zemke2024_all_rna` | 0.3306 | 0.2194 |
| `joint-all-nonencode` | `lora+locon` | 2 | `allen_atac` | 0.5222 | 0.4826 |
| `joint-all-nonencode` | `lora+locon` | 2 | `allen_rna` | 0.2673 | 0.3929 |
| `joint-all-nonencode` | `lora+locon` | 2 | `hda_atac` | 0.7660 | 0.7792 |
| `joint-all-nonencode` | `lora+locon` | 2 | `hda_rna` | 0.4512 | 0.6352 |
| `joint-all-nonencode` | `lora+locon` | 2 | `liu_atac` | 0.7562 | 0.7740 |
| `joint-all-nonencode` | `lora+locon` | 2 | `liu_rna` | 0.4331 | 0.4354 |
| `joint-all-nonencode` | `lora+locon` | 2 | `zemke2023_atac` | 0.3847 | 0.6228 |
| `joint-all-nonencode` | `lora+locon` | 2 | `zemke2023_rna` | 0.2582 | 0.1849 |
| `joint-all-nonencode` | `lora+locon` | 2 | `zemke2024_all_atac` | 0.7222 | 0.7292 |
| `joint-all-nonencode` | `lora+locon` | 2 | `zemke2024_all_rna` | 0.3273 | 0.2283 |
