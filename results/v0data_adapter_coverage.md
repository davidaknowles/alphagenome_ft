...
| Johansen 2025 | `johansen_joint` | human, macaque, marmoset | lora: human, macaque, marmoset; lora+locon: human, macaque, marmoset | missing native evaluations |
...
| `johansen-human` | 4 | 5 | 4 | matched result available |
| `johansen_joint` | 1 | 1 | 1 | matched result available |
| `liu-hdma` | 5 | 5 | 5 | matched result available |
