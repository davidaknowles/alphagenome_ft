...
These values characterize the raw-UMI direct-gene auxiliary target. The reported model RNA metric uses released coordinate-resolved RPKM tracks, so these ceilings do not apply directly to that metric.
