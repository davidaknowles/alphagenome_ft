...
The retained groups also have adequate RNA sampling for the initial screen. In Liu, ATAC fragment depth and RNA unique-molecular-identifier depth have Spearman correlation 0.79. The corresponding correlations between ATAC fragments and expression depth are 0.96, 0.99, and 1.00 in Johansen human, macaque, and marmoset. All 140 retained Liu groups have at least 1.68 million RNA counts and 136 have at least 1,000 cells. The minimum RNA cell counts among retained Johansen groups are 159 for human, 286 for macaque, and 220 for marmoset. A separate RNA-depth filter is therefore not added to this factorial comparison.
