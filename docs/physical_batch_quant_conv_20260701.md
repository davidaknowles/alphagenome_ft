...
- Pointwise Conv1d(k=1) quantization converts 10 additional modules. It helped NVFP4 throughput at batch 20, was neutral for BnB NF4, and hurt TorchAO float8.
- For the best speed/memory tradeoff from this run, use `torchao_nvfp4_weight_only_linear_1x1conv` at physical batch 20.
