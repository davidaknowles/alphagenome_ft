...
suffix="${weight//./p}"
source_config=outputs/v0data/johansen-fragment-joint-depth-filtered/species.json
output_root="outputs/v0data/johansen-fragment-joint-depth-filtered-geneonly-rowcorrw${suffix}"
...
smoke=$(sbatch --parsable --gres=gpu:l40s:2 --time=00:30:00 --cpus-per-task=8 \
