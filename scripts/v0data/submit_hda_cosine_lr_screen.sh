...
common="DATASET=hda-joint,TARGETS_CONFIG=outputs/v0data/hda-joint/targets.json,RUN_SUFFIX=_cosine3e4_screen,LEARNING_RATE=3e-4,LEARNING_RATE_SCHEDULE=warmup_cosine,MINIMUM_LEARNING_RATE_RATIO=0.1,NUM_DEVICES=2"
